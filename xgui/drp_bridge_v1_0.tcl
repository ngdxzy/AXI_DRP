...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "DRP_CLK_FREQ_HZ"
...
proc update_PARAM_VALUE.DRP_CLK_FREQ_HZ { PARAM_VALUE.DRP_CLK_FREQ_HZ } {
	# Procedure called to update DRP_CLK_FREQ_HZ when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.DRP_CLK_FREQ_HZ { PARAM_VALUE.DRP_CLK_FREQ_HZ } {
	# Procedure called to validate DRP_CLK_FREQ_HZ
	return true
}
